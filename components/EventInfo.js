...
export default function EventInfo({ attendance, onOpenConfirm }) {
  ...
  const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=-34.70973916475195,-58.61920422438275`;
          ...
          <Reveal>
            <div className="flex flex-col items-center w-full max-w-full">
              <div className="relative w-24 h-24 flex items-center justify-center mb-6">
                <motion.img
                  animate={{ scale: [1, 0.9, 1.2, 1], rotate: [0, -5, 5, 0] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  src="https://fixdate.io/modelo-invitacion/126/img/img_circuloFiesta.svg"
                  className="w-14 h-14 md:w-16 md:h-16 brightness-0 invert opacity-80"
                  alt="Fiesta"
                />
              </div>
              ...
              <div className="grid grid-cols-1 gap-12 w-full max-w-2xl mt-10">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="min-h-[60px] flex items-center justify-center mb-4">
                    <h3 className="text-sm text-white font-sans">Sábado 22 de marzo, 21hs</h3>
                  </div>
      ...
      {isCalendarOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-6" onClick={() => setIsCalendarOpen(false)}>
          <div className="bg-[#1a1a1a] border border-[#c0c0c0]/20 p-8 rounded-2xl max-w-sm w-full flex flex-col items-center shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=XV+de+Maite+-+Jah+Jireh&dates=20260322T210000/20260323T060000&location=Tres+Cruces+1915,+Rafael+Castillo" target="_blank" rel="noopener noreferrer" className="w-full text-center py-4 border-b border-[#c0c0c0]/10 text-white text-sm font-sans">Google Calendar</a>
            <a href="/evento.ics" className="w-full text-center py-4 border-b border-[#c0c0c0]/10 text-white text-sm font-sans">Apple / Outlook</a>
